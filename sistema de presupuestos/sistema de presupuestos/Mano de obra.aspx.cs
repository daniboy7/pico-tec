...
{
    public partial class Mano_de_obra : System.Web.UI.Page
    {
        ...
        private void BindGridView()
        {
            ...
            try
            {
                ...
                cmd2 = new MySqlCommand("verManoObra", cn);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@FKTipoRecurso", 3);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                if (res == 1)
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Mano de obra borrado correctamente" + "');", true);
                }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (res == 1)
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Mano de obra actualizado correctamente" + "');", true);
                }
                GridView1.EditIndex = -1;
                BindGridView();
