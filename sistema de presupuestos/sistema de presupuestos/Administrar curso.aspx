<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Administrar curso.aspx.cs" Inherits="sistema_de_presupuestos.Administrar_curso" %>
...
<body>
    ...
    <section class="contenido wrapper">
        ...
        <div id="divRegistrar">
            <br />
            <p style="text-align:justify;color:white;font: 150% sans-serif;margin-left:20px;">ADMINISTRAR CURSO </p>
        </div>

    <form id="form1" runat="server">
        <div id="formulario">

        <asp:TextBox ID="TextBox1" runat="server" placeholder="Carné" CssClass="input" Font-Size="Large"></asp:TextBox>

        <asp:Button ID="Button2" runat="server" Text="Buscar"  CssClass="button" Font-Size="Large" OnClick="Button2_Click" />

        <br />
        <br />
        <asp:Label ID="Label1" runat="server" Text="Estudiante : " CssClass="label" Font-Size="Large"></asp:Label>
        <asp:DropDownList ID="DropDownList1" runat="server"></asp:DropDownList>

        <br />
        <br />

        <asp:Label ID="Label2" runat="server" Text="Curso : " CssClass="label" Font-Size="Large"></asp:Label>
        <asp:DropDownList ID="DropDownList2" runat="server"></asp:DropDownList>

        <br />
        <br />

        <asp:Button ID="Button1" runat="server" Text="Agregar estudiante"  CssClass="button" Font-Size="Large" OnClick="Button1_Click" />
        ...
        <div id ="Vista">
            <br />
            <p style="text-align:justify;color:white;font: 150% sans-serif;margin-left:20px;">ESTUDIANTES AGREGADOS </p>
            </div>
        
            <br />

            <asp:GridView ID="GridView1" DataKeyNames="ID" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnRowDeleting="GridView1_RowDeleting" OnRowDataBound = "OnRowDataBound">
