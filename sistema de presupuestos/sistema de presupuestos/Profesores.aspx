<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profesores.aspx.cs" Inherits="sistema_de_presupuestos.Profesores" %>
...
<body>
    ...
    <section class="contenido wrapper">
        ...
        <div id="divRegistrar">
            <br />
            <p style="text-align:justify;color:white;font: 150% sans-serif;margin-left:20px;">REGISTRAR PROFESOR </p>
        </div>
        ...
        <div id="formulario">
            ...
            <asp:TextBox ID="TextBox2" runat="server" placeholder="Primer apellido" CssClass="input" Font-Size="Large"></asp:TextBox>
            <asp:TextBox ID="TextBox3" runat="server" placeholder="Segundo apellido" CssClass="input" Font-Size="Large"></asp:TextBox>
            <asp:TextBox ID="TextBox4" runat="server" placeholder="Email" CssClass="input" Font-Size="Large"></asp:TextBox>
            <asp:TextBox ID="TextBox5" runat="server" placeholder="Contraseña" CssClass="input" Font-Size="Large" TextMode="Password"></asp:TextBox>

            <asp:Button ID="Button1" runat="server" Text="Registrar"  CssClass="button" Font-Size="Large" OnClick="Button1_Click" />
