<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Curso.aspx.cs" Inherits="sistema_de_presupuestos.Curso" %>
...
<body>
    ...
    <section class="contenido wrapper">
        ...
        <div id="divRegistrar">
            <br />
            <p style="text-align:justify;color:white;font: 150% sans-serif;margin-left:20px;">CREAR CURSO </p>
        </div>

        <form id="form1" runat="server">
            <div id="formulario">
                <asp:Label ID="ID" runat="server" Visible="false"></asp:Label>
                <asp:TextBox ID="TextBox1" runat="server" placeholder="Nombre" Font-Size="Large" CssClass="input"></asp:TextBox>
                <asp:TextBox ID="TextBox2" runat="server" placeholder="Semestre" Font-Size="Large" CssClass="input" ></asp:TextBox>
                <asp:TextBox ID="TextBox3" runat="server" placeholder="Año" Font-Size="Large" CssClass="input" ></asp:TextBox>
                <asp:TextBox ID="TextBox4" runat="server" placeholder="Número de grupo" Font-Size="Large" CssClass="input" ></asp:TextBox>

                <asp:Button ID="Button1" runat="server" Text="Crear"  Font-Size="Large"  CssClass="button" OnClick="Button1_Click" />
            ...
            <div id ="Vista">
            <br />
            <p style="text-align:justify;color:white;font: 150% sans-serif;margin-left:20px;">CURSOS </p>
            </div>
