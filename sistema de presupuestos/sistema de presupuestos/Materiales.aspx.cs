    ...
    public partial class Materiales : System.Web.UI.Page
    {
        ...
        private void BindGridView()
        {
            ...
            try
            {
                ...
                cmd2 = new MySqlCommand("select idFamilia,Nombre from familia", cn);
                cmd3 = new MySqlCommand("verMateriales", cn);
                ...
                DropDownList2.DataValueField = "idFamilia";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@FKTipoRecurso", 1);
                cmd.Parameters.AddWithValue("@FKFamilia", this.DropDownList2.SelectedValue);
                ...
                if (res == 1)
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Material agregado correctamente" + "');", true);
                }
                BindGridView();
                cn.Close();
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                ...
                if (res == 1)
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Material borrado correctamente" + "');", true);
                }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (res == 1)
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('" + "Material actualizado correctamente" + "');", true);
                }
                GridView1.EditIndex = -1;
                BindGridView();
