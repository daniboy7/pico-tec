<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mano de obra.aspx.cs" Inherits="sistema_de_presupuestos.Mano_de_obra" %>
...
<body>
    ...
    <section class="contenido wrapper">
        ...
        <div id="divRegistrar">
            <br />
            <p style="text-align:justify;color:white;font: 150% sans-serif;margin-left:20px;">CREAR MANO DE OBRA </p>
        </div>
    ...
    <div id="formulario">
        ...
        <div id ="Vista">
            <br />
            <p style="text-align:justify;color:white;font: 150% sans-serif;margin-left:20px;">MANO DE OBRA </p>
        </div>
        <br />
