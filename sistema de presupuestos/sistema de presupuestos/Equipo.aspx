<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Equipo.aspx.cs" Inherits="sistema_de_presupuestos.Equipo" %>
...
<body>
    ...
    <section class="contenido wrapper">
        ...
        <div id="divRegistrar">
            <br />
            <p style="text-align:justify;color:white;font: 150% sans-serif;margin-left:20px;">CREAR EQUIPO DE CONSTRUCCION </p>
        </div>
    ...
    <div id="formulario">
        ...
        <span>
            <br />
            <asp:Label ID="Label1" runat="server" Text="Unidad : " CssClass="label" Font-Size="Large" Width="81px"></asp:Label>
        ...
        <div id ="Vista">
            <br />
            <p style="text-align:justify;color:white;font: 150% sans-serif;margin-left:20px;">EQUIPO DE CONSTRUCCION </p>
        </div>
