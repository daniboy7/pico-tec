<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Materiales.aspx.cs" Inherits="sistema_de_presupuestos.Materiales" %>
...
<body>
    ...
    <section class="contenido wrapper">
        ...
        <div id="divRegistrar">
            <br />
            <p style="text-align:justify;color:white;font: 150% sans-serif;margin-left:20px;">CREAR MATERIAL </p>
        </div>
    ...
    <div id="formulario">
        ...
        <asp:Label ID="Label1" runat="server" Text="Unidad : " CssClass="label" Font-Size="Large"></asp:Label>
        <asp:DropDownList ID="DropDownList1" runat="server"></asp:DropDownList>
        <br />
        <br />
        
        <asp:TextBox ID="TextBox2" runat="server" placeholder="&#8353; Precio unitario" CssClass="input" Font-Size="Large"></asp:TextBox>

        <asp:Label ID="Label2" runat="server" Text="Familia : " CssClass="label" Font-Size="Large"></asp:Label>
        ...
        <div id ="Vista">
            <br />
            <p style="text-align:justify;color:white;font: 150% sans-serif;margin-left:20px;">MATERIALES </p>
        </div>
